...
const RemoveShippingAddressModal = ({ isOpen, onClose }) => {
  return (
    <>
              ...
              >
                <Dialog.Panel className="mx-4 sm:mx-0 w-full max-w-[375px] transform mt-24 p-7 bg-white  text-left align-middle  transition-all rounded-md">
                  ...
                  <div className="py-4  flex items-center justify-between gap-2 group">
                    <h3 className="font-bold">Remove shipping address</h3>
                  </div>
                  <p className="sm:text-md text-base text-t4">
                    Are you sure you want to remove this shipping address?
                  </p>

                  <button className="primary-button mt-12" onClick={onClose}>
                    Yes
                  </button>
                  <button
...
export default RemoveShippingAddressModal;
