    ...
    >
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative flex items-center">
          <Listbox.Button className="relative w-[118px] px-3.5  cursor-default text-sm text-input1 font-medium gap-2 border-gray outline-none flex items-center">
      ...
      <div className="relative flex-1">
        <input
          ...
          pattern="[0-9]*"
          placeholder=""
          className="floating-input border-0 border-l focus-visible:border-input1 rounded-none peer"
        />
        <label htmlFor={htmlFor} className="floating-label">
          {label}
        </label>
      </div>
    </div>
