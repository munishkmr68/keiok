      ...
      <div className="max-w-[484px] mx-auto  px-4">
        ...
        <div className="divide-y divide-gray mt-24 pt-[30px] border-t border-gray">
          ...
          <div className="py-[30px]">
            <div className="text-t2 mb-0.5 font-medium text-base">Order Number:</div>
            <p className="text-t4 text-sm">321140866</p>
          </div>
          <div className="py-[30px]">
            <div className="text-t2 mb-0.5 font-medium text-base">Tracking Number:</div>
            <p className="text-t4 text-sm">
              We&apos;ll email you as soon as we have your tracking number.
            </p>
          </div>
          <div className="py-[30px]">
            <div className="text-t2 mb-0.5 font-medium text-base">Shipping Method:</div>
          ...
          <div className="py-[30px]">
            <div className="text-t2 mb-0.5 font-medium text-base">Shipping Address:</div>
            <p className="text-t4 text-sm">Wed, Sep 06 - Mon, Sep 11</p>
          </div>
          <div className="py-[30px]">
            <div className="text-t2 mb-0.5 font-medium text-base">
