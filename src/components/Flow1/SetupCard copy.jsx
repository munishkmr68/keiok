  ...
  return (
    <>
      ...
      <div className="max-w-[484px] mx-auto px-4 py-8">
        ...
        {billingAddressSameAsShipping ? null : (
          <>
            ...
            <button className="primary-button w-auto font-medium min-w-[124px]">Save</button>
            <button className="primary-button-text-only w-auto font-medium">Cancel</button>
            </div>
          </>
        )}
